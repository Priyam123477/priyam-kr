...
<body>
    ...
    <div>
        ...
        <asp:TextBox ID="TextBox1" placeholder="Course ID" runat="server"></asp:TextBox>
        ...
        <p>
            ...
            <asp:TextBox ID="TextBox3" placeholder="Description" runat="server"></asp:TextBox>
        </p>
        <p>
            <asp:TextBox ID="TextBox4" placeholder="Grade ID" runat="server"></asp:TextBox>
        </p>
        <asp:Button ID="Button1" runat="server" Height="44px" Text="New record"  Width="175px" OnClick="Button1_Click"/>
        <asp:Button ID="Button2" runat="server" Height="44px" Text="Save record"  Width="175px"  OnClick="Button2_Click"/>
        <asp:Button ID="Button3" runat="server" Height="44px" Text="Update record"  Width="175px"  OnClick="Button3_Click"/>
        ...
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4" DataSourceID="SqlDataSource1" ForeColor="#333333" GridLines="None" Height="254px" Width="1437px">
