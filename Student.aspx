...
<body>                      
    ...
    <div>
        <table class="auto-style1">
            <tr>
                <td><asp:TextBox ID="TextBox1" placeholder="Student Id" runat="server"></asp:TextBox>
                </td>
                <td>&nbsp;</td>
            ...
            <tr>
                <td><asp:TextBox ID="TextBox9" placeholder="Parent Id" runat="server"></asp:TextBox>
                </td>
                <td>&nbsp;</td>
           
                <td><asp:TextBox ID="TextBox10" placeholder="Date Of Join" runat="server"></asp:TextBox>
                </td>
                <td>&nbsp;</td>
            </tr>
            <tr>
                <td><asp:TextBox ID="TextBox11" placeholder="Status" runat="server"></asp:TextBox>
                </td>
                <td>&nbsp;</td>
          
                <td><asp:TextBox ID="TextBox12" placeholder="last Login Date" runat="server"></asp:TextBox>
                </td>
                <td>&nbsp;</td>
            </tr>
            <tr>
                <td><asp:TextBox ID="TextBox13" placeholder="Last Login Ip" runat="server"></asp:TextBox>
                </td>
                <td>&nbsp;</td>
            </tr>
        </table>
        ...
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#999999" BorderStyle="None" BorderWidth="1px" CellPadding="3" DataSourceID="SqlDataSource1" GridLines="Vertical" Height="171px" style="margin-right: 0px" Width="1382px">
