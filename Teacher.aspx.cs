...
public partial class Teacher : System.Web.UI.Page
{
    ...
    protected void Button2_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            cmd.CommandText = "insert into teacher values('" + TextBox1.Text + "','" + TextBox2.Text + "','" + TextBox3.Text + "','" + TextBox4.Text + "','" + TextBox5.Text + "','" + TextBox6.Text + "','" + TextBox7.Text + "','" + TextBox8.Text + "','" + TextBox9.Text + "','" + TextBox10.Text + "','" + TextBox11.Text + "')";
            cmd.ExecuteNonQuery();
    ...
    protected void Button3_Click(object sender, EventArgs e)
    {
        ...
        {
            SqlCommand cmd = conn.CreateCommand();
            cmd.CommandText = "update teacher set email='" + TextBox2.Text + "',password='" + TextBox3.Text + "',fname='" + TextBox4.Text + "',lname='" + TextBox5.Text + "',dob='" + TextBox6.Text + "',phone='" + TextBox7.Text + "',mobile='" + TextBox8.Text + "',status='" + TextBox9.Text + "',last_login_date='" + TextBox10.Text + "',last_login_ip='" + TextBox11.Text + "' where teacher_id='" + TextBox1.Text + "' ";
            cmd.ExecuteNonQuery();
